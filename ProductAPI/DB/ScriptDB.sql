...
INSERT INTO `product` VALUES (1,'LECHE PREMIUN',3.40),(2,'GASEOSA PAIS',1.70),(3,'ACEITE PREMIUN',4.20),(4,'AZUCAR RUBIA',2.23),(5,'LENTEJAS REAL',5.40),(6,'PAN MOLDE',3.40),(7,'CHOCOLATE AMARGO',10.50);
/*!40000 ALTER TABLE `product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'dbproduct'
--
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddNewProduct`(
	IN _NameProduct VARCHAR(50),
    IN _PriceProduct DECIMAL(10,2)
)
BEGIN
	INSERT INTO product (NameProduct, PriceProduct)
    VALUE (_NameProduct,_PriceProduct);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetProductoById`(
	IN _IdProduct INT
)
BEGIN
...
-- Dump completed on 2024-07-16 16:55:24
